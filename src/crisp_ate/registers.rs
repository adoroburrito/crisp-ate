...
impl fmt::Debug for CrispsAteDecodedOpcodes {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        let name: &str = match self {
            ...
            CrispsAteDecodedOpcodes::StoreLeastBitOfVXAndShiftVXRight(_) => "StoreLeastBitOfVXAndShiftVXRight (8XY6)",
            CrispsAteDecodedOpcodes::SetVXToVYMinusVX(_, _) => "SetVXToVYMinusVX (8XY7)",
            CrispsAteDecodedOpcodes::StoreMostBitOfVXAndShiftVXLeft(_) => "StoreMostBitOfVXAndShiftVXLeft (8XYE)",
            ...
            CrispsAteDecodedOpcodes::SetVXToBitwiseANDWithSaltAndRandom(_, _) => "SetVXToBitwiseANDWithSaltAndRandom (CXNN)",
            ...
            CrispsAteDecodedOpcodes::SkipIfKeyAtVXIsNotPressed(_) => "SkipIfKeyAtVXIsNotPressed (EXA1)",
            ...
            CrispsAteDecodedOpcodes::StoreBinaryCodedDecimalVX(_) => "StoreBinaryCodedDecimalVX (FX33)",
            CrispsAteDecodedOpcodes::StoreFromV0ToVXStartingFromI(_) => "StoreFromV0ToVXStartingFromI (FX55)",
            CrispsAteDecodedOpcodes::FillFromV0ToVXStartingFromI(_) => "FillFromV0ToVXStartingFromI (FX65)",
        ...
        let values_hex: Vec<String> = match self {
            ...
            CrispsAteDecodedOpcodes::SkipIfVXEquals(val1, val2) => vec![hex(*val1 as u16), hex(*val2 as u16)],
            CrispsAteDecodedOpcodes::SkipIfVXNotEqual(val1, val2) => vec![hex(*val1 as u16), hex(*val2 as u16)],
            CrispsAteDecodedOpcodes::SkipIfVXEqualsVY(val1, val2) => vec![hex(*val1 as u16), hex(*val2 as u16)],
            CrispsAteDecodedOpcodes::SetVX(val1, val2) => vec![hex(*val1 as u16), hex(*val2 as u16)],
            CrispsAteDecodedOpcodes::AddToVX(val1, val2) => vec![hex(*val1 as u16), hex(*val2 as u16)],
            CrispsAteDecodedOpcodes::SetVXToVY(val1, val2) => vec![hex(*val1 as u16), hex(*val2 as u16)],
            CrispsAteDecodedOpcodes::SetVXToVXorVY(val1, val2) => vec![hex(*val1 as u16), hex(*val2 as u16)],
            CrispsAteDecodedOpcodes::SetVXToVXandVY(val1, val2) => vec![hex(*val1 as u16), hex(*val2 as u16)],
            CrispsAteDecodedOpcodes::SetVXToVXxorVY(val1, val2) => vec![hex(*val1 as u16), hex(*val2 as u16)],
            CrispsAteDecodedOpcodes::AddVYtoVX(val1, val2) => vec![hex(*val1 as u16), hex(*val2 as u16)],
            CrispsAteDecodedOpcodes::SubtractVYFromVX(val1, val2) => vec![hex(*val1 as u16), hex(*val2 as u16)],
            CrispsAteDecodedOpcodes::StoreLeastBitOfVXAndShiftVXRight(val1) => vec![hex(*val1 as u16)],
            CrispsAteDecodedOpcodes::SetVXToVYMinusVX(val1, val2) => vec![hex(*val1 as u16), hex(*val2 as u16)],
            CrispsAteDecodedOpcodes::StoreMostBitOfVXAndShiftVXLeft(val1) => vec![hex(*val1 as u16)],
            CrispsAteDecodedOpcodes::SkipIfVXNotEqualVY(val1, val2) => vec![hex(*val1 as u16), hex(*val2 as u16)],
            CrispsAteDecodedOpcodes::SetIAddress(val1) => vec![hex(*val1)],
            CrispsAteDecodedOpcodes::JumpToAddress(val1) => vec![hex(*val1)],
            CrispsAteDecodedOpcodes::SetVXToBitwiseANDWithSaltAndRandom(val1, val2) => vec![hex(*val1 as u16), hex(*val2 as u16)],
            CrispsAteDecodedOpcodes::DrawSpriteAt(val1, val2, val3) => vec![hex(*val1 as u16), hex(*val2 as u16), hex(*val3 as u16)],
        ...
        let values_dec: Vec<u16> = match self {
            ...
            CrispsAteDecodedOpcodes::SkipIfVXEquals(val1, val2) => vec![(*val1 as u16), (*val2 as u16)],
            CrispsAteDecodedOpcodes::SkipIfVXNotEqual(val1, val2) => vec![(*val1 as u16), (*val2 as u16)],
            CrispsAteDecodedOpcodes::SkipIfVXEqualsVY(val1, val2) => vec![(*val1 as u16), (*val2 as u16)],
            ...
            CrispsAteDecodedOpcodes::SetVXToVXorVY(val1, val2) => vec![(*val1 as u16), (*val2 as u16)],
            CrispsAteDecodedOpcodes::SetVXToVXandVY(val1, val2) => vec![(*val1 as u16), (*val2 as u16)],
            CrispsAteDecodedOpcodes::SetVXToVXxorVY(val1, val2) => vec![(*val1 as u16), (*val2 as u16)],
            CrispsAteDecodedOpcodes::AddVYtoVX(val1, val2) => vec![(*val1 as u16), (*val2 as u16)],
            CrispsAteDecodedOpcodes::SubtractVYFromVX(val1, val2) => vec![(*val1 as u16), (*val2 as u16)],
            CrispsAteDecodedOpcodes::StoreLeastBitOfVXAndShiftVXRight(val1) => vec![(*val1 as u16)],
            CrispsAteDecodedOpcodes::SetVXToVYMinusVX(val1, val2) => vec![(*val1 as u16), (*val2 as u16)],
            CrispsAteDecodedOpcodes::StoreMostBitOfVXAndShiftVXLeft(val1) => vec![(*val1 as u16)],
            CrispsAteDecodedOpcodes::SkipIfVXNotEqualVY(val1, val2) => vec![(*val1 as u16), (*val2 as u16)],
            CrispsAteDecodedOpcodes::SetIAddress(val1) => vec![(*val1)],
            CrispsAteDecodedOpcodes::JumpToAddress(val1) => vec![(*val1)],
            CrispsAteDecodedOpcodes::SetVXToBitwiseANDWithSaltAndRandom(val1, val2) => vec![(*val1 as u16), (*val2 as u16)],
            CrispsAteDecodedOpcodes::DrawSpriteAt(val1, val2, val3) => vec![(*val1 as u16), (*val2 as u16), (*val3 as u16)],
